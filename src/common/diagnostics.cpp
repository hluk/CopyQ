...
QString pluginsPath()
{
    ...
    return appImageAdjustedPath(QStringLiteral(COPYQ_PLUGIN_PREFIX));
#else
    QDir dir;
...
QString themesPath()
{
    ...
    return appImageAdjustedPath(QStringLiteral(COPYQ_THEME_PREFIX));
#else
...
QString translationsPath()
{
    ...
    return appImageAdjustedPath(QStringLiteral(COPYQ_TRANSLATION_PREFIX));
#else
