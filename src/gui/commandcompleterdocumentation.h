...
void addDocumentation(AddDocumentationCallback addDocumentation)
{
    ...
    addDocumentation("selection", "ByteArray selection([mimeType])", "Same as `clipboard()` for `Linux mouse selection`_.");
    addDocumentation("hasClipboardFormat", "bool hasClipboardFormat(mimeType)", "Returns true only if clipboard contains MIME type.");
    addDocumentation("hasSelectionFormat", "bool hasSelectionFormat(mimeType)", "Same as `hasClipboardFormat()` for `Linux mouse selection`_.");
    ...
    addDocumentation("networkGetAsync", "NetworkReply networkGetAsync(url)", "Same as `networkGet()` but the request is asynchronous.");
    addDocumentation("networkPostAsync", "NetworkReply networkPostAsync(url, postData)", "Same as `networkPost()` but the request is asynchronous.");
