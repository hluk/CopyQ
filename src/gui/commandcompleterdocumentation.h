...
void addDocumentation(AddDocumentationCallback addDocumentation)
{
    ...
    addDocumentation("clipboard", "clipboard([mimeType]) -> :js:class:`ByteArray`", "Returns clipboard data for MIME type (default is text).");
    addDocumentation("selection", "selection([mimeType]) -> :js:class:`ByteArray`", "Same as `clipboard()` for `Linux mouse selection`_.");
    ...
    addDocumentation("read", "read(mimeType, row, ...) -> :js:class:`ByteArray`", "Returns concatenated data from items, or clipboard if row is negative.");
    ...
    addDocumentation("input", "input() -> :js:class:`ByteArray`", "Returns standard input passed to the script.");
    ...
    addDocumentation("fromUnicode", "fromUnicode(String, encodingName) -> :js:class:`ByteArray`", "Returns encoded text.");
    addDocumentation("data", "data(mimeType) -> :js:class:`ByteArray`", "Returns data for automatic commands or selected items.");
    ...
    addDocumentation("selectedItemData", "selectedItemData(index) -> array of :js:class:`Item`", "Returns data for given selected item.");
    addDocumentation("setSelectedItemData", "setSelectedItemData(index, Item) -> bool", "Set data for given selected item.");
    addDocumentation("selectedItemsData", "selectedItemsData() -> array of :js:class:`Item`", "Returns data for all selected items.");
    ...
    addDocumentation("unpack", "unpack(data) -> :js:class:`Item`", "Returns deserialized object from serialized items.");
    addDocumentation("pack", "pack(Item) -> :js:class:`ByteArray`", "Returns serialized item.");
    addDocumentation("getItem", "getItem(row) -> :js:class:`Item`", "Returns an item in current tab.");
    ...
    addDocumentation("fromBase64", "fromBase64(base64String) -> :js:class:`ByteArray`", "Returns base64-decoded data.");
    addDocumentation("md5sum", "md5sum(data) -> :js:class:`ByteArray`", "Returns MD5 checksum of data.");
    addDocumentation("sha1sum", "sha1sum(data) -> :js:class:`ByteArray`", "Returns SHA1 checksum of data.");
    addDocumentation("sha256sum", "sha256sum(data) -> :js:class:`ByteArray`", "Returns SHA256 checksum of data.");
    addDocumentation("sha512sum", "sha512sum(data) -> :js:class:`ByteArray`", "Returns SHA512 checksum of data.");
    addDocumentation("open", "open(url, ...) -> bool", "Tries to open URLs in appropriate applications.");
    addDocumentation("execute", "execute(argument, ..., null, stdinData, ...) -> :js:class:`FinishedCommand` or `undefined`", "Executes a command.");
    ...
    addDocumentation("commands", "commands() -> array of :js:class:`Command`", "Return list of all commands.");
    addDocumentation("setCommands", "setCommands(Command[])", "Clear previous commands and set new ones.");
    addDocumentation("importCommands", "Command[] importCommands(String) -> array of :js:class:`Command`", "Return list of commands from exported commands text.");
    addDocumentation("exportCommands", "String exportCommands(Command[]) -> string", "Return exported command text.");
    addDocumentation("networkGet", "NetworkReply networkGet(url) -> :js:class:`NetworkReply`", "Sends HTTP GET request.");
    addDocumentation("networkPost", "NetworkReply networkPost(url, postData) -> :js:class:`NetworkReply`", "Sends HTTP POST request.");
    addDocumentation("networkGetAsync", "NetworkReply networkGetAsync(url) -> :js:class:`NetworkReply`", "Same as `networkGet()` but the request is asynchronous.");
    addDocumentation("networkPostAsync", "NetworkReply networkPostAsync(url, postData) -> :js:class:`NetworkReply`", "Same as `networkPost()` but the request is asynchronous.");
    addDocumentation("env", "env(name) -> :js:class:`ByteArray`", "Returns value of environment variable with given name.");
    ...
    addDocumentation("screenshot", "screenshot(format='png', [screenName]) -> :js:class:`ByteArray`", "Returns image data with screenshot.");
    addDocumentation("screenshotSelect", "screenshotSelect(format='png', [screenName]) -> :js:class:`ByteArray`", "Same as `screenshot()` but allows to select an area on screen.");
    ...
    addDocumentation("arguments", "(Array)", "Array for accessing arguments passed to current function or the script (`arguments[0]` is the script itself).");
    addDocumentation("global", "global", "Object allowing to modify global scope which contains all functions like `copy()` or `add()`. This is useful for :ref:`commands-script`.");
    ...
    addDocumentation("mimeClipboardMode", "(application/x-copyq-clipboard-mode)", "Contains `selection` if data is from `Linux mouse selection`_.");
    ...
    addDocumentation("plugins.itemsync.mimeBaseName", "(application/x-copyq-itemsync-basename)", "MIME type for accessing base name (without full path).");
    addDocumentation("plugins.itemtags.userTags", "(Array)", "List of user-defined tags.");
    ...
    addDocumentation("plugins.itemtags.mimeTags", "(application/x-copyq-tags)", "MIME type for accessing list of tags.");
